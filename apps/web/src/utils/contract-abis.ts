/**
 * ABI for CeloStaking Contract
 */
export const CELO_STAKING_ABI = [
  {
    "inputs": [],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct CeloStaking.Stake[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
...
/**
 * ABI for CeloRewards Contract
 */
export const CELO_REWARDS_ABI = [
  {
    "inputs": [],
    "stateMutability": "nonpayable",
    "type": "constructor"
    ...
    "outputs": [
      {
        ...
        "internalType": "struct CeloRewards.Reward[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      ...
      { "internalType": "uint256", "name": "claimed", "type": "uint256" },
      { "internalType": "uint256", "name": "rewardsCount", "type": "uint256" }
    ],
    "stateMutability": "view",
    "type": "function"
  },
